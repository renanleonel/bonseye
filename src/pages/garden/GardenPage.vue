...
<template>
  <div class="py-8">
    ...
    <div
      v-if="isEmpty"
      data-cy="garden-empty"
      class="py-16 flex justify-center flex-col items-center"
    >
      ...
      <router-link to="/">
        <Button
          data-cy="button-browse-plants"
          class="bg-green-800/50 hover:bg-green-700/50 cursor-pointer"
    ...
    >
      <div v-for="plant in plants" :key="plant.id" class="relative group" data-cy="garden-item">
        <PlantCard :plant="plant" />
        <button
          data-cy="button-remove-from-garden"
